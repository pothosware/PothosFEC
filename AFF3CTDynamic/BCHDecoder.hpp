...
class BCHDecoder : public aff3ct::module::Decoder_BCH<B,R>
{
private :
	const int t2;
...
public:
	BCHDecoder(const int& K, const int& N, const aff3ct::tools::BCH_polynomial_generator<B> &GF, const int n_frames = 1);
