...
RADecoder<B, R>
::RADecoder(const int& K, const int& N, const Interleaver<R>& interleaver, int max_iter, const int n_frames)
...
{
	const std::string name = "RADecoder";
	this->set_name(name);
...
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::RADecoder<B_8,Q_8>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::RADecoder<B_16,Q_16>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::RADecoder<B_32,Q_32>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::RADecoder<B_64,Q_64>;
#else
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::RADecoder<B,Q>;
#endif
// ==================================================================================== explicit template instantiation
