...
template <typename B>
CRCPolynomialInter<B>
::CRCPolynomialInter(const int K, std::string poly_key, const int size, const int n_frames)
: aff3ct::module::CRC_polynomial<B>(K, poly_key, size, n_frames)
{
	const std::string name = "CRCPolynomialInter";
	this->set_name(name);
...
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::CRCPolynomialInter<B_8>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::CRCPolynomialInter<B_16>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::CRCPolynomialInter<B_32>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::CRCPolynomialInter<B_64>;
#else
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::CRCPolynomialInter<B>;
#endif
// ==================================================================================== explicit template instantiation
