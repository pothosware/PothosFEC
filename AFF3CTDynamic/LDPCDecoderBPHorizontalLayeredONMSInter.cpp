...
LDPCDecoderBPHorizontalLayeredONMSInter<B,R>
::LDPCDecoderBPHorizontalLayeredONMSInter(const int K, const int N, const int n_ite,
...
: Decoder               (K, N, n_frames, mipp::N<R>()                                                       ),
  ...
  V_reorderered         (N                                                                                  )
{
	const std::string name = "LDPCDecoderBPHorizontalLayeredONMSInter";
	this->set_name(name);
...
template <typename B, typename R>
void LDPCDecoderBPHorizontalLayeredONMSInter<B,R>
::reset()
{
	this->init_flag = true;
}
...
// --------------------------------------------------------------------------------------------------------- saturation
template <typename R>
inline mipp::Reg<R> simd_sat(const mipp::Reg<R> val, const R)
{
	return val;
}
template <>
...
template <> inline mipp::Reg<short > simd_normalize<short, 1>(const mipp::Reg<short > v, const float) { return (v >> 3);                       } // v * 0.125
template <> inline mipp::Reg<short > simd_normalize<short, 2>(const mipp::Reg<short > v, const float) { return            (v >> 2);            } // v * 0.250
template <> inline mipp::Reg<short > simd_normalize<short, 3>(const mipp::Reg<short > v, const float) { return (v >> 3) + (v >> 2);            } // v * 0.375
template <> inline mipp::Reg<short > simd_normalize<short, 4>(const mipp::Reg<short > v, const float) { return                       (v >> 1); } // v * 0.500
template <> inline mipp::Reg<short > simd_normalize<short, 5>(const mipp::Reg<short > v, const float) { return (v >> 3) +            (v >> 1); } // v * 0.625
template <> inline mipp::Reg<short > simd_normalize<short, 6>(const mipp::Reg<short > v, const float) { return            (v >> 2) + (v >> 1); } // v * 0.750
template <> inline mipp::Reg<short > simd_normalize<short, 7>(const mipp::Reg<short > v, const float) { return (v >> 3) + (v >> 2) + (v >> 1); } // v * 0.825
template <> inline mipp::Reg<short > simd_normalize<short, 8>(const mipp::Reg<short > v, const float) { return v;                              } // v * 1.000
template <> inline mipp::Reg<float > simd_normalize<float, 8>(const mipp::Reg<float > v, const float) { return v;                              } // v * 1.000
template <> inline mipp::Reg<double> simd_normalize<double,8>(const mipp::Reg<double> v, const float) { return v;                              } // v * 1.000
...
template <typename B, typename R>
bool LDPCDecoderBPHorizontalLayeredONMSInter<B,R>
...
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::LDPCDecoderBPHorizontalLayeredONMSInter<B_8,Q_8>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::LDPCDecoderBPHorizontalLayeredONMSInter<B_16,Q_16>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::LDPCDecoderBPHorizontalLayeredONMSInter<B_32,Q_32>;
template class AFF3CTDynamic::POTHOS_SIMD_NAMESPACE::LDPCDecoderBPHorizontalLayeredONMSInter<B_64,Q_64>;
// ==================================================================================== explicit template instantiation
